		...
		<div class="content-container clearfix">
			...
			<main>
				...
				<div class="margin-top text-align-center">
					<a class="btn-text btn-cancel" href="list.jsp">목록</a> <a
						class="btn-text btn-default" href="edit.jsp">수정</a> <a
						class="btn-text btn-default" href="del.jsp">삭제</a>
				</div>
